      ...
      <View style={styles.actionsContainer}>
        ...
        <View style={styles.actionGrid}>
          ...
          >
            ...
            <Text style={styles.actionDesc}>Submit new incident report</Text>
          </TouchableOpacity>
          ...
          >
            ...
            <Text style={styles.actionDesc}>Browse all tickets</Text>
          </TouchableOpacity>
          ...
          {(user?.role === 'groundstaff' || user?.role === 'admin') && (
            ...
            >
              ...
              <Text style={styles.actionDesc}>Admin functions</Text>
            </TouchableOpacity>
          )}
        </View>
      </View>
